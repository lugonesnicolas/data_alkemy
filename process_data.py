...
def limpieza():
    ...
    df_cines = pd.read_csv('datos/cines/2022-05/cines-08-05-2022.csv',sep=',',header=0) 
    df_cines.rename(columns={'Cod_Loc':'cod_localidad','IdProvincia':'id_provincia','IdDepartamento':'id_departamento','Categoría':'categoria',
        ...
        'CP':'código postal','Teléfono':'numero de telefono','Mail':'mail','Web':'web'},inplace=True)
    ...
    df_cines.to_csv('datos/cines/2022-05/cines-08-05-2022.csv', index=None)
    
    df_museos = pd.read_csv('datos/museos/2022-05/museos-08-05-2022.csv',sep=',',header=0)
    df_museos.rename(columns={'Cod_Loc':'cod_localidad','IdProvincia':'id_provincia','IdDepartamento':'id_departamento','categoria':'categoria',
        ...
        'CP':'codigo postal','telefono':'numero de telefono','Mail':'mail','Web':'web'},inplace=True)
    ...
    df_museos = df_museos.fillna('s/d')
    df_museos.to_csv('datos/museos/2022-05/museos-08-05-2022.csv', index=None)
