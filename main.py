...
"""Funcion que toma el diccionario con los links, toma los 2 items.
...
Hacemos uso de requests para descargar el link del archivo csv, definimos la ruta codificada con nombre y fecha, creamos el directorio, y los archivos correspondientes.
"""
try:
    dirs_dict = {}
    ...
    logging.exception(f'No se encontraron los links: {e}')


"""Limpiamos nuestros Data Frames, renombramos y exportamos"""
...
logging.info(f'Se renombraron los data frames')
